...
app.use((req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', [
    ...
    "connect-src 'self' https://v3-cinemeta.strem.io https://torrentio.strem.io https://*.strem.io https://*.stremio.com https://api.themoviedb.org https://www.usatv.click https://*.fly.dev https://*.herokuapp.com",
